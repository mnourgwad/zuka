...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.45]{Final_CAD_model}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.45]{Redundancy_problem}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{redundancy_constrains}
...
\smallskip
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.45]{Motor_3_torque}
