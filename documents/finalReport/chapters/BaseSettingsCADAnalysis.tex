...
%In order to calculate the main dimensions of the base, we have followed two different procedures: the first is to use the given forces and moments found in the KUKA manuals with the mechanical design equations to get the dimensions of each part of the base, and the second is to 
...
\begin{table}[H]
	\centering
	\includegraphics[scale=0.8]{mesh3}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.08]{MoldedConcrete}	
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.08, angle=270]{IMG1481}	
