...
\include{chapters/abstract}%\cleardoublepage{}
...
%\input{chapters/CADanalysisApproach}
...
%
%\chapter{KUKA conditioning} \label{ch:conditioning}
%\input{chapters/KUKAconditioning}
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%\cleardoublepage
%\input{chapters/kinectsaftyzone}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%\chapter{Experiments Guide} \label{ch:Experiments}
